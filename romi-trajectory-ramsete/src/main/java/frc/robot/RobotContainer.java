...
public class RobotContainer {
  ...
  private Command generateRamseteCommand() {
    ...
    String trajectoryJSON = "paths/CC.wpilib.json"; //change the ".json" to get a different path to run as long as file is in src/main/deploy/paths
    //Trajectory trajectory = new Trajectory();
      try {
  ...
  public Command getArcadeDriveCommand() {
    return new ArcadeDrive(
        m_drivetrain, () -> -m_controller.getRawAxis(1), () -> m_controller.getRawAxis(4)/1.25);
